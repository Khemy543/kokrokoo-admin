...
function ESelectRateCard(props) {
    ...
    const pass=()=>{
        ...
        props.history.push("/admin/exiting-title",{id:id, media_house_id:props.location.state.media_house_id});
    }
        ...
        {isActiveSpinner?
          ...
          <Row>
            ...
            <CardHeader className=" bg-transparent">
                  <h3 className=" mb-0">SELECT RATECARD</h3>
            </CardHeader>
...
export default ESelectRateCard;
