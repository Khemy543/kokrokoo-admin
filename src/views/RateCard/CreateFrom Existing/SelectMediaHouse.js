...
function ERateSelectMediaHouse(props) {
        ...
        <p
          ...
          <Row style={{marginTop:"20px"}}>
              {media_houses.map((value,index)=>(
                <SubCompanyCard data={value} {...props} path="existing-select-rateCard"/>
              ))}
...
export default ERateSelectMediaHouse;
