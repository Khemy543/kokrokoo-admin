...
function EditRateCardTitle(props) {
    ...
    const handlTitleSubmit=(e)=>{
        ...
        axios.patch(`${domain}/api/admin/ratecard/${props.location.state.title_id}/update-title`,{
        ...
        .then(res=>{
            ...
            if(res.data[1] === "saved"){
                if(props.location.state.id == '3'){
                    props.history.push("/admin/edit/print",{title_id:props.location.state.title_id});
                }
                else{
                    props.history.push("/admin/edit/video",{title_id:props.location.state.title_id});
                }
...
export default EditRateCardTitle;
