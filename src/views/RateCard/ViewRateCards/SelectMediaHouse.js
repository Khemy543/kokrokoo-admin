...
function VRateSelectMediaHouse(props) {
        ...
        <p
          ...
          <Row style={{marginTop:"20px"}}>
              {media_houses.map((value,index)=>(
                <SubCompanyCard data={value} {...props} path="select-rate-card"/>
              ))}
...
export default VRateSelectMediaHouse;
